...
| S36 | Search | Pretraga dokumenata po različitim kriterijima | F | P2 | M | DONE | 6 |
| S37 | Filteri | Filtriranje dokumenata po statusu, tipu i datumu | F | P2 | M | DONE | 6 |
| S38 | Edit podataka | Omogućavanje korisniku da ručno ispravi izdvojene podatke | F | P1 | M | DONE | 7 |
| S39 | Validacija polja | Provjera da su sva obavezna polja popunjena | T | P1 | S | DONE | 7 |
| S40 | Validacija formata | Validacija formata datuma i numeričkih vrijednosti | T | P1 | S | DONE | 7 |
| S41 | Matematička validacija | Provjera konzistentnosti iznosa (PDV, subtotal, ukupno) | T | P2 | M | DONE | 7 |
| S42 | Spremanje validacije | Čuvanje validiranih i korigovanih podataka | T | P1 | M | DONE | 7 |
| S43 | Test validacije | Testiranje validacije i korekcije podataka | T | P2 | M | DONE | 7 |
| S44 | Model firme | Definisanje modela organizacije koja koristi sistem | T | P1 | M | DONE | 8 |
| S45 | Model korisnika | Definisanje korisničkog modela i veze sa firmom | T | P1 | M | DONE | 8 |
| S46 | Registracija firme | Omogućavanje registracije nove firme u sistemu | F | P1 | M | DONE | 8 |
| S47 | Admin nalog | Kreiranje prvog administratorskog korisnika firme | F | P1 | M | DONE | 8 |
| S48 | Login | Implementacija prijave korisnika u sistem | F | P1 | M | DONE | 8 |
| S49 | Logout | Omogućavanje odjave korisnika | F | P1 | S | DONE | 8 |
| S50 | Auth sigurnost | Implementacija sigurnosti (hashiranje lozinki, tokeni) | T | P1 | M | DONE | 8 |
| S51 | Multi-tenant zaštita | Osiguranje da korisnici vide samo podatke svoje firme | T | P1 | M | DONE | 8 |
| S52 | Test auth | Testiranje autentifikacije i autorizacije | T | P2 | M | DONE | 8 |
| S53 | Role model | Definisanje korisničkih rola u sistemu | T | P1 | M | DONE | 8 |
| S54 | Kreiranje korisnika | Omogućavanje adminu da dodaje nove korisnike | F | P1 | M | DONE | 8 |
| S55 | Dodjela rola | Dodjela rola korisnicima | F | P1 | M | DONE | 8 |
| S56 | Test workflow | Testiranje workflow logike i rola | T | P2 | M | DONE | 8 |
| S57 | Reset password | Omogućavanje resetovanja lozinke | F | P2 | M | DONE | 8 |
| S58 | Dashboard | Prikaz osnovnih statistika sistema | F | P3 | M | DONE | 8 |
| S59 | User management | Upravljanje korisničkim podacima | F | P2 | M | DONE | 8 |
| S60 | Status model | Definisanje statusa dokumenta i tranzicija | T | P1 | M | DONE | 9 |
| S61 | Status history | Evidentiranje historije promjena statusa | F | P3 | M | DONE | 9 |
| S62 | Slanje na odobrenje | Omogućavanje slanja dokumenta na odobrenje | F | P1 | M | DONE | 9 |
| S63 | Odobravanje/odbijanje | Donošenje odluke o dokumentu uz komentar | F | P1 | M | DONE | 9 |
| S64 | Pending lista | Prikaz dokumenata koji čekaju akciju korisnika | F | P2 | S | DONE | 9 |
| S65 | Audit log | Evidencija svih ključnih akcija nad dokumentom | T | P1 | M | DONE | 9 |
| S66 | UI audit log | Prikaz audit zapisa korisniku | F | P3 | S | DONE | 9 |
| S67 | Komentari | Dodavanje komentara na dokumente | F | P2 | M | DONE | 9 |
| S68 | Pending view | Fokusirani prikaz zadataka korisnika | F | P3 | S | DONE | 9 |
| S69 | XML mapping | Mapiranje validiranih podataka u XML strukturu | T | P1 | M | DONE | 10 |
| S70 | XML generator | Generisanje XML fajla iz podataka | F | P1 | M | DONE | 10 |
| S71 | Pregled XML | Prikaz XML sadržaja korisniku | F | P3 | S | DONE | 10 |
| S72 | Download XML | Omogućavanje preuzimanja XML fajla | F | P1 | S | DONE | 10 |
| S73 | Spremanje XML | Čuvanje XML fajla uz dokument | T | P1 | M | DONE | 10 |
| S74 | Final status | Završetak obrade dokumenta | F | P2 | S | DONE | 10 |
| S75 | Test XML | Testiranje XML generisanja i završnog toka | T | P2 | M | DONE | 10 |
| S76 | Notifikacije | Obavještenja o promjenama statusa dokumenata | F | P3 | M | DONE | 10 |
| S77 | Testovi | Testiranje naprednih funkcionalnosti | T | P2 | M | DONE | 10 |
