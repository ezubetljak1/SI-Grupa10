...
public interface DocumentMapper {
    ...
    @Mapping(target = "documentType", expression = "java(DocumentType.valueOf(request.getDocumentType()))")
    ...
    @Mapping(target = "documentType", expression = "java(request.getDocumentType() != null ? DocumentType.valueOf(request.getDocumentType()) : entity.getDocumentType())")
    @Mapping(target = "documentStatus", expression = "java(request.getDocumentStatus() != null ? DocumentStatus.valueOf(request.getDocumentStatus()) : entity.getDocumentStatus())")
    void updateEntity(DocumentUpdateRequest request, @MappingTarget DocumentEntity entity);
